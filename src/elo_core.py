...
class match:
    ...
    def __init__(self, match_type: str, player_alpha: Optional[Player] = None, player_beta: Optional[Player] = None,
        ...
        self.match_id = hash(self.match_date)
...
teams_registry.add_team(ksh)
teams_registry.add_team(rns)

# lets have a match between our two teams
test_3s_match = match('3v3', team_alpha=ksh, team_beta=rns)
test_3s_match.setup_match_parameters()
test_3s_match.report_match_results(ksh, rns)
